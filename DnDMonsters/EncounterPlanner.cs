...
namespace DnDMonsters
{
    public partial class EncounterPlanner : Form
    {
        ...
        public void AddMonster(Monster m, bool summary)
        {
            if (m == null) return;
        ...
        TableLayoutPanel DisplayMonster(ActiveMonster mm, int maxWidth){
            ...
            p.MaximumSize = new System.Drawing.Size(maxWidth, maxWidth);
            p.Refresh();
            ...
            if (mm.Summary)
            {
                ...
                Label l1 = NewLabel(m.Name + "    ", LabelTypes.heading, maxWidth);
            ...
            else
            {
                ...
                //Name
                p.Controls.Add(NewLabel(m.Name, LabelTypes.heading, maxWidth));
                //type, size
                p.Controls.Add(NewLabel(m.Size + " " + m.Type + ", " + m.Alignment, LabelTypes.tiny, maxWidth));
                //AC, Speed, HP
                ...
                ac_line.Controls.Add(NewLabel(m.AC.ToString(), LabelTypes.text, maxWidth));
                ac_line.Controls.Add(NewLabel("Speed:", LabelTypes.subHeading, maxWidth));
                ac_line.Controls.Add(NewLabel(m.Speed, LabelTypes.text, maxWidth));
                ac_line.Controls.Add(NewLabel("MaxHP:", LabelTypes.subHeading, maxWidth));
                ac_line.Controls.Add(NewLabel(m.HP, LabelTypes.text, maxWidth));
                ac_line.Controls.Add(NewLabel("XP:", LabelTypes.subHeading, maxWidth));
                ac_line.Controls.Add(NewLabel(m.XP.ToString(), LabelTypes.text, maxWidth));
                ...
                if (m.nAttacks != "" && m.nAttacks != "1")
                    p.Controls.Add(NewLabel("Available attacks: " + m.nAttacks, LabelTypes.text, maxWidth));
                ...
                foreach (Attack a in m.Attacks)
                {
                    ...
                    attack_panel.Controls.Add(NewLabel("   " + a.Name, LabelTypes.bold, maxWidth), 0, row);
                    attack_panel.Controls.Add(NewLabel(a.Type.ToString(), LabelTypes.italic, maxWidth), 1, row);
                    attack_panel.Controls.Add(NewLabel(a.ToHit(), LabelTypes.text, maxWidth), 2, row);
                    attack_panel.Controls.Add(NewLabel(a.Damage, LabelTypes.text, maxWidth), 3, row);
                    if (a.Type == Attack.AttackType.Ranged)
                    {
                        if (a.MaxRangeDisadv == 0)
                            attack_panel.Controls.Add(NewLabel("Range: " + a.MaxRange.ToString(), LabelTypes.text, maxWidth), 4, row);
                        else
                            attack_panel.Controls.Add(NewLabel("Range: " + a.MaxRange.ToString() +
                                " / " + a.MaxRangeDisadv.ToString(), LabelTypes.text, maxWidth), 5, row);
                    }
                    if (a.Special != "")
                        attack_panel.Controls.Add(NewLabel(a.Special, LabelTypes.text, maxWidth), 1, row + 1);
                    row += 2;
                }
                ...
                if (m.SpellDC > 0)
                {
                    p.Controls.Add(NewLabel("Spells", LabelTypes.subHeading, maxWidth));
                    p.Controls.Add(NewLabel("    DC=" + m.SpellDC.ToString() + " Attack=" + Attack.ToHit(m.SpellRngAttack), LabelTypes.text, maxWidth));
                    ...
                    spell_panel.Controls.Add(NewLabel(m.SpellsCantrips, LabelTypes.italic, maxWidth), 1, 0);
                    for (int lvl = 1; lvl <= m.Spells.Count; lvl++)
                    {
                        ...
                        spell_panel.Controls.Add(NewLabel(m.Spells[lvl].Item2, LabelTypes.italic, maxWidth), 1, lvl);
                    }
                ...
                if (m.Saves != "")
                {
                    ...
                    data_panel.Controls.Add(NewLabel(m.Saves, LabelTypes.text, maxWidth), 1, data_panel_row++);
                }
                if (m.Skills != "")
                {
                    data_panel.Controls.Add(NewLabel("Skills:", LabelTypes.bold, maxWidth), 0, data_panel_row);
                    data_panel.Controls.Add(NewLabel(m.Skills, LabelTypes.text, maxWidth), 1, data_panel_row++);
                }
                if (m.Vuln != "")
                {
                    data_panel.Controls.Add(NewLabel("Vulnerable:", LabelTypes.bold, maxWidth), 0, data_panel_row);
                    data_panel.Controls.Add(NewLabel(m.Vuln, LabelTypes.text, maxWidth), 1, data_panel_row++);
                }
                if (m.Resist != "")
                {
                    data_panel.Controls.Add(NewLabel("Resistant:", LabelTypes.bold, maxWidth), 0, data_panel_row);
                    data_panel.Controls.Add(NewLabel(m.Resist, LabelTypes.text, maxWidth), 1, data_panel_row++);
                }
                if (m.Immune != "")
                {
                    data_panel.Controls.Add(NewLabel("Immunities:", LabelTypes.bold, maxWidth), 0, data_panel_row);
                    data_panel.Controls.Add(NewLabel(m.Immune, LabelTypes.text, maxWidth), 1, data_panel_row++);
                }
                ...
                data_panel.Controls.Add(NewLabel(sense, LabelTypes.text, maxWidth), 1, data_panel_row++);
                ...
                if (m.Descr != "")
                {
                    ...
                    p.Controls.Add(NewLabel("   " + m.Descr, LabelTypes.text, maxWidth));
                }
            }
            return p;
        }
